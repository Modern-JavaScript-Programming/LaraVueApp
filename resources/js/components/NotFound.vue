<template>
  <div class="row justify-content-center mt-4">
    <div class="col-md-12">
      <h1>Not found what are you looking!!</h1>
      <svg
      ...
      >
        ...
        <title>content</title>
        <ellipse cx="1023.75" cy="834.07" rx="100.11" ry="24.73" fill="#6c63ff" opacity="0.1"></ellipse>
        <ellipse cx="140.04" cy="838.19" rx="100.11" ry="24.73" fill="#6c63ff" opacity="0.1"></ellipse>
        <path
        ...
        ></rect>
        <rect x="77.8" y="157.68" width="947.42" height="528.97" rx="12.49" ry="12.49" fill="#fff"></rect>
        <rect x="77.8" y="157.68" width="947.42" height="528.97" rx="12.49" ry="12.49" fill="#fff"></rect>
        <rect
          x="77.8"
          y="157.68"
        ...
        <g id="83eb5f8b-b68b-4721-b047-6100bc74156f" data-name="buttons">
          <circle cx="96.72" cy="164.18" r="6.5" fill="#fff"></circle>
          <circle cx="114.22" cy="164.18" r="6.5" fill="#fff"></circle>
          <circle cx="131.72" cy="164.18" r="6.5" fill="#fff"></circle>
        </g>
        <rect x="141.22" y="293.86" width="790" height="392.78" rx="10.19" ry="10.19" fill="#fff"></rect>
        <rect
          x="107.72"
          y="203.45"
          width="227.24"
        ...
        <path
          ...
          fill="#ffd037"
        ></path>
        <ellipse cx="713.64" cy="758.15" rx="62" ry="9.51" fill="#6c63ff" opacity="0.1"></ellipse>
        <path
        ...
        <circle cx="935.51" cy="546.26" r="0.23" fill="#e6e8ec"></circle>
        <rect x="849.12" y="551.42" width="181.18" height="208.22" rx="6.61" ry="6.61" fill="#fff"></rect>
        <rect
          x="849.12"
          y="551.42"
          width="181.18"
          ...
          opacity="0.1"
        ></rect>
        <rect x="858.36" y="562.04" width="162.7" height="186.98" rx="6.61" ry="6.61" fill="#fff"></rect>
        <rect
          x="882.03"
          y="599.54"
          width="111.62"
          ...
          fill="#6c63ff"
        ></rect>
        <rect x="886.13" y="652.15" width="103.43" height="7.86" fill="#6c63ff"></rect>
        <rect x="868.55" y="668.74" width="142.32" height="7.86" fill="#6c63ff"></rect>
        <rect x="868.55" y="686.2" width="142.32" height="7.86" fill="#6c63ff"></rect>
        <rect x="868.55" y="703.66" width="142.32" height="7.86" fill="#6c63ff"></rect>
        <rect y="482.59" width="426.61" height="208.22" rx="6.61" ry="6.61" fill="#fff"></rect>
        <rect
          y="482.59"
          width="426.61"
          height="208.22"
          ...
          opacity="0.1"
        ></rect>
        <rect x="21.76" y="493.21" width="383.08" height="186.98" rx="6.61" ry="6.61" fill="#fff"></rect>
        <rect x="77.51" y="530.72" width="262.81" height="38.52" rx="6.03" ry="6.03" fill="#6c63ff"></rect>
        <rect x="87.15" y="583.32" width="243.53" height="7.86" fill="#6c63ff"></rect>
        <rect x="45.75" y="599.91" width="335.1" height="7.86" fill="#6c63ff"></rect>
        <rect x="45.75" y="617.37" width="335.1" height="7.86" fill="#6c63ff"></rect>
        <rect x="45.75" y="634.83" width="335.1" height="7.86" fill="#6c63ff"></rect>
        <path
        ...
        <path
          ...
          opacity="0.1"
        ></path>
        <circle cx="183.01" cy="496.73" r="18.31" fill="#ffcdd3"></circle>
        <path
        ...
        <path
          ...
          opacity="0.1"
        ></path>
        <circle cx="281.2" cy="508.32" r="1.23" fill="#575988"></circle>
        <circle cx="279.53" cy="510.72" r="1.23" fill="#575988"></circle>
        <circle cx="277.9" cy="512.93" r="1.23" fill="#575988"></circle>
        <circle cx="276.2" cy="515.33" r="1.23" fill="#575988"></circle>
        <circle cx="131.25" cy="509.62" r="1" fill="#575988"></circle>
        <circle cx="131.01" cy="511.88" r="1" fill="#575988"></circle>
        <circle cx="130.78" cy="514.14" r="1" fill="#575988"></circle>
        <path
